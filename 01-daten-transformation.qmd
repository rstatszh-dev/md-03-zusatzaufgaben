...
5.  Welche Datentypen sind in den Variablen enthalten? (Als Erinnerung: [rstatszh-k011.github.io/website/folien/md-02-datenvisualisierung.html#/variablen-typen](https://rstatszh-k011.github.io/website/folien/md-02-datenvisualisierung.html#/variablen-typen){.uri})
...
## Aufgabe 4: Environment

In allen obigen Aufgaben hast du Code geschrieben, um die `penguins`-Daten zu transformieren. Die Ergebnisse erschienen in der Console, wurden aber nirgendwo gespeichert.

Der folgende Code-Block verhält sich anders. Führe ihn aus und beobachte, was im Environment-Fenster (oberes rechtes Fenster in RStudio) passiert.
...
1.  Welches neue Objekt erscheint in deinem Environment?

2.  Was ist der Unterschied zwischen diesem Code und den vorherigen Code-Blöcken?

3.  Warum würden wir den Zuweisungsoperator `<-` verwenden, um unsere Ergebnisse zu speichern?

## Aufgabe 5: Daten kommunizieren
